...
\footnotetext {Autre titre : \emph{Là-haut sur la colline}. Une version plus proche des origines de cette chanson se trouve dans "69 Chansons d'Etudiants" (1984).}

\beginverse
Du haut de la montagne,
Nom de Dieu ! Joséphin', laisse-toi faire !
Du haut de la montagne,
\bis {Descendait un gros cu-}
\endverse
