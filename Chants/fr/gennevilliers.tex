...
ititle= {Gennevilliers (À)},
ititle= {Fille de Gennevilliers (la)},
ititle= {Beau grenadier (le)},
tu= {Les Filles de Gennevilliers (in Les Fleurs du Mâle, 1972)}]

\footnotetext {Autres titres : Le beau grenadier , La fille de Gennevilliers.}
...
Frappant du pied, levant les bras\footnote {Variante : yeux.} aux cieux
...
\bis {Sans en avoir eu aucun agrément !\footnote { Originale : Pour n'en avoir que de l'emmerdement !}}
\endverse
